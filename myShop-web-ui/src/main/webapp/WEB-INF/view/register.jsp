...
<div class="beij_center">
    <div class="ger_zhuc_beij">
        <div class="ger_zhuc_biaot">
            <ul>
                <li class="ger_border_color"><a href="<%=request.getContextPath()%>members/register">个人注册</a></li>
                <i>丨</i>
                <li><a href="#">申请入驻</a></li>
                <p>我已经注册，现在就<a class="ftx-05 ml10" href="<%=request.getContextPath()%>/members/login">登录</a></p>
            </ul>
        </div>
        <div class="zhuc_biaod">
            <form action="<%=request.getContextPath()%>/members/register" method="post">
            <div class="reg-items" >
            ...
            <div class="reg-items" >
                ...
                <input  name="email" class="i-text" type="text">
                <%--<!--备注————display使用 inline-block-->--%>
                <%--<div class="msg-box">--%>
        ...
        <div class="xiaogg">
            <img src="<%=request.getContextPath()%>/static/images/cdsgfd.jpg">
        </div>
    </div>
</div>
...
<div class="jianj_dib jianj_dib_1">
    ...
    <script type="text/javascript">
        window.onload(check());
        function check() {
            <% if (request.getParameter("registerresult") !=null ){%>
                alert("1");
            <%}%>
        }
