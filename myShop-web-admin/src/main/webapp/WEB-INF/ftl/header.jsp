...
<link rel="shortcut icon" href="<%=request.getContextPath()%>/static/dist/img/favicon.ico">
<!-- Bootstrap 3.3.7 -->
...
<!-- DataTables -->
<link rel="stylesheet" href="<%=request.getContextPath()%>/static/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
